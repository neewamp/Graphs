...
(*   Definition rebuildGraph_GraphConst2 G : t := *)
(*     Vertices.fold (fun v G => *)
(*                      (Edges.fold (fun e E =>  *)
(*                if  Vertices.E.eq_dec (snd (destructEdge e)) v || *)
(*                       Vertices.E.eq_dec (fst (destructEdge e)) v) *)


(*          && Vertices.mem (fst (destructEdge e)) (enumVertices G) || *)
(*         Vertices.mem (snd (destructEdge e)) (enumVertices G) *)
(*      then addEdge e else E) (enumEdges G)) (addVertex v) empty) *)
(*                   empty (enumVertices G) . *)

                                                               
                                                         

(* rebuildGraph_GraphConst1 *)
